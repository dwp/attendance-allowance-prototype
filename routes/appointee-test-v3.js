...
const controllers = require('../controllers/appointee-test-v3');
...
// claim submission
router.use(`/${urls.declaration}`, controllers.declaration);
router.use(`/${urls.applicationComplete}`, controllers.applicationComplete);
