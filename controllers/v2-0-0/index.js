...
const countryOutsideUk = require('./eligibility/country-outside-uk');
...
const difficultiesStartDateDay = require('./care-needs-day/difficulties-start-date-day');
...
const fallingStumbling = require('./care-needs-day/falling-stumbling');
...
const communicationDayFrequency = require('./care-needs-day/communication-day-frequency');
...
const difficultiesStartDateNight = require('./care-needs-night/difficulties-start-date-night');
...
module.exports = {
  ...
  difficultiesStartDateDay,
  difficultiesStartDateNight,
  movingIndoorsDay,
  toiletDay,
  toiletDayFrequency,
  eatDrinkDay,
