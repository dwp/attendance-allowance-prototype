...
module.exports = (req, res, next) => {
  ...
  if (req.body?.['special-rules-form-upload']) {
    req.session.data['special-rules-form-upload'] = req.body['special-rules-form-upload'];
    req.session.data['special-rules-form-upload-rows'].pop();
